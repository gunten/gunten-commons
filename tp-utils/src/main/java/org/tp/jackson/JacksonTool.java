...
import static org.tp.exception.SysConstants.JSON_STRING_EMPTY_DESC;
...
public class JacksonTool {
    ...
    private static PropertyNamingStrategy SNAKE_CASE = new JacksonSnakeCaseStrategy();
    ...
    public static String parseToJsonString(Object object) {
        ...
        try {
            ...
            throw new MyUtilsException(e, BizCodeMsgEnum.OBJECT_TO_JSON_ERROR.getCode(), e.getMessage(),
                    JacksonTool.class);
        }
    }
    ...
    public static JsonNode parseToJsonNode(Object object) {
        ...
        try {
            ...
            throw new MyUtilsException(e, BizCodeMsgEnum.OBJECT_TO_JSON_NODE_ERROR.getCode(), e.getMessage(),
                    JacksonTool.class);
        }
    }
    ...
    public static <T> T parseToObject(String json, Class<T> clazz) {
        ...
        try {
            ...
            throw new MyUtilsException(e, BizCodeMsgEnum.PARSE_JOSN_ERROR.getCode(), e.getMessage(),
                    JacksonTool.class);
        }
    }
     ...
     * @return
     */
    public static boolean isValidJson(String jsonInput, ObjectMapper objectMapper){
        try{
